"""
Этап 8. Бутстрап доверительные интервалы
Стационарный блочный бутстрап, переобучение t-HMM на B ресемплах, CI на nu/волатильность/VaR/ES/частоту пробоев.
Выход: bootstrap_ci.csv, bootstrap_ci.parquet

Исходный артефакт: bootstrap_ci.csv
